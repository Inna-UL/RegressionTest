...
11. Get Parties from Certificate
	[Tags]	Functional	certificate create	POST    current
    Get Parties from Certificate using Role    ${Certificate_Id}   Public;Owner;Brand%20Owner;Production%20Site;Local%20Representative;Applicant
    Should not be Empty     ${cert_parties}
    ${parties}	get_parties  ${cert_parties}   relationshipType
    ${list}  convert_str_to_list     ['Brand Owner', 'Production Site', 'Local Representative', 'Applicant']
