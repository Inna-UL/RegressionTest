...
6. Lock the collection
    ...
    ${response}  Lock Collection    Lock_Template.json    ${product_collection_id}
#    run keyword if  ${response._content} != {"apiversion":"${Api_ver}","code":204,"status":"No Content","message":"No Content","data":{}}  Fail	test1 Teardown
    run keyword if  ${response._content} != {"code":204,"status":"No Content","message":"No Content","data":{}}  Fail	test1 Teardown
