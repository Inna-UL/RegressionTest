...
*** Variables ***
#${API_ENDPOINT}	https://dev.informationplatform.ul.com	#For DEV basic auth
#${API_ENDPOINT}	https://platform-np-api-dev.azurewebsites.net	#For DEV basic auth
${API_ENDPOINT}	https://uliodev.azure-api.net/InformationPlatformServicesDEV  #For DEV OAuth2

#@{database}  pymysql    infopltfrm_transDBv07  ul_transUser    29LPMW6Ljv  usnbkinpt018d.global.ul.com    3316	#DB for DEV old
...
#Basic Auth
${user_name}    ipdevusr    #for DEV
${password}     ipdevusr@uL123&$#   #for DEV
#OAuth 2
${AUTH_ENDPOINT}        https://login.microsoftonline.com/ul.onmicrosoft.com/oauth2/token
${Grant_Type}           client_credentials
${Client_ID}            108b1166-1352-4636-8ccd-34ed0611dbc1
${Client_Secret}        oey3KPPqmN4O4vG_DE.mG.~S~-XmzM4SJi
${Scope}                User.Read
