...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_21/inputrequest/Link_Product1toComponent1.json     ${asset_Id_Product1}
...
19. Modify Product1
	[Tags]	Functional	POST	current
    run keyword and ignore error  Modify Product1 Asset   group02/Test_Case_01/inputrequest/ModifyProduct1.json    ${asset_Id_Product1}
