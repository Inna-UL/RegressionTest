...
3. Asset Summary with Modified Date & Owner Reference
    [Tags]	Functional	notcurrent
    get present_date
    Summary of Asset with Error   fromModifiedDate=${Today_Date}&toModifiedDate=${Today_Date}
    should be equal  '${err_msg}'  'At least one other parameter should be entered along with Date parameters'
