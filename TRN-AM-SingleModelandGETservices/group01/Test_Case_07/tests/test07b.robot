...
3. Asset Summary with Created Date, Modified Date & Owner Reference
    [Tags]	Functional	notcurrent
    get present_date
    run keyword and ignore error  Summary of Asset   fromCreatedDate=&toCreatedDate=&fromModifiedDate=${Today_Date}&toModifiedDate=${Today_Date}&ownerReference_PartySiteID=invalid
