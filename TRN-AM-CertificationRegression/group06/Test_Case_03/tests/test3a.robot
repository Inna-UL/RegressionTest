...
13. View Certificate with missing Certificate Params
    [Tags]	Functional	current
    run keyword and ignore error  View Certificate  certificateType=Regression%20Scheme&certificateName=${Certificate_Name}
