...
#${API_ENDPOINT}	https://platform-np-api-qa.azurewebsites.net	#For UAT
...
@{database}   pymysql    infopltfrm_transDBv07    RW_Automation    [RC]~yz#D.(6K=MV  ip-q-ss.mysql.database.azure.com    3306  	#DB for UAT
