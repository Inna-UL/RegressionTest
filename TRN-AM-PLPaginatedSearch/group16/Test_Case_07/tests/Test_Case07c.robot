...
21. Search Certificate with "hasParties" field:''
	...
	set global variable  ${hasPLParties_value}    ${EMPTY}
	Paginated Search for PL Certificate    PL_Certificate_Search_with_hasParties.json
	...
	length should be  ${certificate_findkeys}  ${value_as_3}
