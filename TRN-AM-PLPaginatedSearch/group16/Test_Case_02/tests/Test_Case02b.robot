...
21.Search Certificate with searchText as Prodcut Type
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchText_value}    ${certificate_type_1}
...
21a. Validate PL Certificate Details
	...
	should be equal  ${CS_certificate_Id}   ["${PrivateLabel_Id}"]
...
21b. Validate findKeys searchText Details
    ...
    should be equal  ${FK_searchText}  ${certificate_type_1}