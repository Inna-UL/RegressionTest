...
21. Search Certificate with searchText as PL name
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchText_value}    PL-${certificate_name_1}-${current_time}
	log to console      PL-${certificate_name_1}-${current_time}
...
21b. Validate findKeys searchText Details
    ...
    should be equal  ${FK_searchText}  PL-${certificate_name_1}-${current_time}