...
21. Search Certificate with Offset as '0' & Rows as '0'
	...
	should be equal  ${certificate_total_count}   ${value_as_0}
	should be equal  ${certificate_offset}    ${value_as_0}
	should be equal  ${certificate_rows}   ${value_as_0}
...
21a. Validate PL Certificate Details
    ...
    should be empty  ${certificate_list}
