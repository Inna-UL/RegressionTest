...
24. Unlink Asset From Private Label
    ...
    Unlink Asset from Private Label  Unlink_Asset_Template.json  ${PL_Asset_Id1}

25. View Private Label Asset (PLA1)
    [Tags]	Functional	certificate	PL  POST    current
    run keyword and ignore error  View Private Label Assets    ${PL_Asset_Id1}
...
26. View Private Label Asset (PLA2)
    [Tags]	Functional	certificate	PL  POST    current
    ${result}  View Private Label Assets    ${PL_Asset_Id2}
    run keyword if  '${result}' != '${PL_Asset_Id2}'     Fail   test1 Teardown
