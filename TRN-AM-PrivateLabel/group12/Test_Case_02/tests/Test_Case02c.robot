...
24. Unlink Asset From Private Label
    ...
    ${result}    run keyword and ignore error     Unlink Asset from Private Label     Unlink_Asset_Template.json  ${empty}
    run keyword if  ${result} != ('FAIL', u'200 != 404')  Fail	test1 Teardown
