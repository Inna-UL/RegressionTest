...
19. Unlink Asset From Private Label
    [Tags]	Functional	certificate	PL	POST    current
    set global variable  ${PrivateLabel_Asset_Id}   ${EMPTY}
    ${response}  run keyword and ignore error  Unlink Asset from Private Label  Unlink_Asset_Template.json  ${PrivateLabel_Asset_Id}
