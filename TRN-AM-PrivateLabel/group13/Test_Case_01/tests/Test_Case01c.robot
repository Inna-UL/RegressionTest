...
19. Unlink Party From Private Label
    ...
    set global variable  ${PrivateLabel_Party_Id}   ${EMPTY}
    ${response}  run keyword and ignore error  Unlink Party from Private Label  Unlink_Asset_Template.json  ${PrivateLabel_Party_Id}
    run keyword if  ${response} != ('FAIL', u'200 != 404')  Fail	test1 Teardown
    log to console  ${response}