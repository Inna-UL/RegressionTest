...
25. Post Date CET_V2.1
	[Tags]	Functional	POST	current
	Activate CET   ${certificate_hierarchy_IdV2.1}

29. Post Date CET_V1
	[Tags]	Functional	POST	current
	Activate CET   ${certificate_hierarchy_Id}  #Added extra step

26. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    ...
    run keyword if  '${certificate_hierarchy_Id}' == '${certificate_hierarchy_Id_Modify}'     Fail

27. Get Private Label details from Private Label Table
    [Tags]	Functional	certificate	PL  create	POST    current
    Get PrivateLabelId from Private Label Table     ${Certificate_Id}
