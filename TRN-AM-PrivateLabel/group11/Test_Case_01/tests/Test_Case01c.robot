...
18. View Private Label Assets of a base asset
    [Tags]	Functional	certificate	PL  POST    current
    run keyword and ignore error  View Private Label Assets of a base Asset_one_asset_Id    ${asset_Id_Product1}
#    run keyword if  '${response_api}' != '{"apiversion":"${Api_ver}","code":204,"status":"No Content","message":"No Content","data":{}}'  Fail	test1 Teardown
    run keyword if  '${response_api}' != '{"code":204,"status":"No Content","message":"No Content","data":{}}'  Fail	test1 Teardown
