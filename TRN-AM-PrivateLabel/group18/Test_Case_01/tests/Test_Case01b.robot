...
18. Get Private Label Details for a Base Certificate
    [Tags]	Functional	certificate	PL  create	POST    current
    run keyword and ignore error  Get Private Label Details of a base Certificate  ${Certificate_Name}  Regression%20Scheme    abcdefg
