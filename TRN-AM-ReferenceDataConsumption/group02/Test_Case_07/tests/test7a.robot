...
13. Get Associated Attributes of a Product
    [Tags]	Functional	Test	POST    current  ReferenceData
    run keyword and ignore error  Get Associated Attributes of a Product   ${EMPTY}   ${asset_Id_Product1}
#    run keyword if  "${response}" != "('FAIL', u'HTTPError: HTTP Error 404: Not Found')"     Fail
#    should be equal  '${GAAP_response_api}'   'HTTP Error 404: Not Found'
